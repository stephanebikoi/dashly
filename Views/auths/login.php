<div class="row align-items-center justify-content-center">
    <div class="col-md-7 col-lg-6 px-lg-4 px-xl-8 d-flex flex-column vh-100 py-6">
        ...
        <div>
            ...
            <?php session_destroy() ?>
            <!-- Form -->
            <form action="/auths/login_staff" method="POST">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-4">
                            ...
                            <!-- Input -->
                            <input type="text" class="form-control" placeholder="Your login" required name="username">
                        </div>
                    </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    ...
                                    <!-- Help text -->
                                    <a href="/auths/reset_password" class="form-text small text-muted link-primary">Forgot password</a>
                                </div>
                            </div> <!-- / .row -->
        ...
        <div class="mt-auto">
            ...
            <small class="mb-0 text-muted">
                Connect with admin account <a href="/auths/login_admin" class="fw-semibold">Sign up</a>
            </small>
        </div>
        </div>
