...
<div class="row">
    ...
    <div class="col">
        <form action="/staffs/create_staff" method="POST" novalidate id="taskForm" class="needs-validation">
            ...
            <div class="card border-0 scroll-mt-3" id="basicInformationSection">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg">
                            <input type="text" class="form-control" id="firstameother" value=""  name="otherfirstname">
                ...
                <div class="row mb-4">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg">
                            ...
                            <div class="invalid-feedback">Please select a  poste </div>
                        </div>
                    </div> <!-- / .row -->
