                ...
                <div class="row align-items-center h-100">
                    <div class="col-auto d-flex ms-auto ms-md-0">
                        ...
                        <?php } else { ?>
                                ...
                                <img src="/img/staffs/<?= $staf->profil ?>" alt="Profile picture" class="avatar-img" width="112" height="112">
                ...
                <div class="col">
                    <div class="card border-0 flex-fill w-100">
                        <div class="card-header card-header-space-between">
                            ...
                            <!-- Link -->
                            <a href="#files" data-toggle="tabLink" class="small fw-bold">
                                View all
                            </a>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-borderless align-middle mb-3">
                                <tbody>
                                <?php foreach ($projects as $project): if (!empty($project->file)) {?>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <span class="fs-6 text-muted">Updated 17 mins ago, 18 kb</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                ...
                                <?php foreach ($tasks as $task): if (!empty($task->file)) {?>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <svg width="23" height="30" class="me-3" viewBox="0 0 32 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
